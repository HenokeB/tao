 ...
 */
abstract class ltiProvider_models_classes_LtiTool extends tao_models_classes_Service
{
	/**
	...
	public function getLaunchUrl($parameters = array()) {
		...
		$extID	= $module->getUniquePropertyValue(new core_kernel_classes_Property(PROPERTY_ACL_MODULE_EXTENSION));
