 ...
 * @subpackage models_classes_Matching
 */
class taoQTI_models_classes_Matching_VariableFactory
{
    // --- ASSOCIATIONS ---
...
define the type of the variable
    ...
    public static function create($data, $type = null)
    {
		...
		switch ($type) {
            ...
            case 'tuple':
            case 'point':
				$returnValue = new taoQTI_models_classes_Matching_Tuple ($varValue);
				break;
				
			//Collection List
            case 'array':
            case 'list':
				$returnValue = new taoQTI_models_classes_Matching_List ($varValue);
				break;

            // Shape       
            case 'circle':
            case 'ellipse':
                $returnValue = new taoQTI_models_classes_Matching_Ellipse ($varValue);
                break;
            case 'rect':
            case 'poly':
                $returnValue = new taoQTI_models_classes_Matching_Poly ($varValue);
                break;
			...
			case 'string':
			case 'NULL':
				$returnValue = new taoQTI_models_classes_Matching_BaseTypeVariable ($varValue);
				break;
				
			default:
				throw new Exception ('taoQTI_models_classes_Matching_VariableFactory::create variable type unknown '.$type.' for '.$varValue);
		}
    ...
    public static function createJSONVariableFromQTIData($id, $card, $baseType, $values)
    {
    	...
    	if ($values != null){
    		foreach ($values as $value){
	    		$value = taoQTI_models_classes_Matching_VariableFactory::createJSONValueFromQTIData  ($value, $baseType);	
    		...
    		switch ($baseType){
                ...
                case "point":
    				...
    				break;
    			default:
    				throw new Exception ("taoQTI_models_classes_Matching_VariableFactory::createJSONVariableFromQTIData an error occured while parsing : the type ".$baseType." is unknown");
    		}
    ...
    public static function createJSONValueFromQTIData(   $value, $baseType)
    {
    	...
    	switch ($baseType){
    		...
    		default :
    			throw new Exception ("taoQTI_models_classes_Matching_VariableFactory::createJSONValueFromQTIData an error occured while parsing : the type ".$baseType." is unknown");
    	}
     ...
     * @return taoQTI_models_classes_Matching_BaseTypeVariable
     */
    public static function toNumericBaseType(   $data)
    {
        ...
        if (!($data instanceof taoQTI_models_classes_Matching_BaseTypeVariable)){
            if (taoQTI_models_classes_Matching_BaseTypeVariable::isValidValue ($data)) {
                $matchingVar = new taoQTI_models_classes_Matching_BaseTypeVariable ($data);
...
} /* end of class taoQTI_models_classes_Matching_VariableFactory */
