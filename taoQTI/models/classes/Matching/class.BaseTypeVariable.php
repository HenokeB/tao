 ...
 * @subpackage models_classes_Matching
 */
class taoQTI_models_classes_Matching_BaseTypeVariable
    extends taoQTI_models_classes_Matching_Variable
{
    ...
    public function __construct(   $value)
    {
        ...
        if (! $this->isValidValue($value)){
            throw new Exception ('taoQTI_models_classes_Matching_BaseTypeVariable::_construct an error occured : The value is not a valid value type ['.gettype($value).'], expected [string, boolean, float, integer]');
        }
...
} /* end of class taoQTI_models_classes_Matching_BaseTypeVariable */
