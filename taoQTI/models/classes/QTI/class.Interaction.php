 ...
 */
require_once('taoQTI/models/classes/QTI/class.Response.php');
 ...
 * @subpackage models_classes_QTI
 */
class taoQTI_models_classes_QTI_Interaction
    extends taoQTI_models_classes_QTI_Data
{
     ...
     * @return mixed
     */
    public function addChoice( taoQTI_models_classes_QTI_Choice $choice)
    {
     ...
     * @return mixed
     */
    public function addGroup( taoQTI_models_classes_QTI_Group $group)
    {
     ...
     * @return boolean
     */
    public function removeGroup( taoQTI_models_classes_QTI_Group $group, $recursive = false)
    {
        $returnValue = (bool) false;
     ...
     * @return mixed
     */
    public function setResponse( taoQTI_models_classes_QTI_Response $response)
    {
    ...
    public function setPrompt($text)
    {
    	...
    	$this->prompt = taoQTI_helpers_qti_ItemAuthoring::cleanHTML($text);
...
} /* end of class taoQTI_models_classes_QTI_Interaction */
