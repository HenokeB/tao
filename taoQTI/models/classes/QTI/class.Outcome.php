 ...
 * @subpackage models_classes_QTI
 */
class taoQTI_models_classes_QTI_Outcome
    extends taoQTI_models_classes_QTI_Data
{
    ...
    public function destroy()
    {
        ...
        foreach (taoQTI_models_classes_QTI_QTISessionCache::singleton()->getAll() as $instance) {
        	if ($instance instanceof taoQTI_models_classes_QTI_Item) {
        		$found = false;
...
} /* end of class taoQTI_models_classes_QTI_Outcome */
