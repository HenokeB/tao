...
<div id="qtiAuthoring_main_container">
	...
	<div id="qtiAuthoring_menu_container" class="ui-widget-content ui-corner-top">
		...
		<div id="qtiAuthoring_menu_right_container">
			...
			<div id="qtiAuthoring_menu_interactions_overlay" class="ui-widget-overlay"/>
		</div>
	</div>
</div>
	<div id="tabs-qti">
...
<div id="dialog-confirm" title="" style="display:none;"><p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 20px 0;"></span><span id="dialog-confirm-message"></span></p></div>
...
$(document).ready(function(){
	...
	try{
		...
		$('#AssessmentItem_Form').submit(function(){return false;});
	}catch(err){
