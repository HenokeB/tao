 ...
 * @subpackage actions_QTIform_interaction
 */
class taoQTI_actions_QTIform_interaction_GraphicassociateInteraction
    extends taoQTI_actions_QTIform_interaction_GraphicInteraction
{
    ...
    public function initElements()
    {
		...
		$this->form->addElement(taoQTI_actions_QTIform_AssessmentItem::createTextboxElement($this->getInteraction(), 'maxAssociations', __('Maximum allowed associations')));
        // section 10-13-1-39-643eb156:12d51696e7c:-8000:00000000000050A5 end
    }

} /* end of class taoQTI_actions_QTIform_interaction_GraphicassociateInteraction */
