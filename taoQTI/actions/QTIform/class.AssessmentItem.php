...
//		$this->form->addElement(self::createBooleanElement($this->item, 'adaptive', ''));
     ...
     */
    public static function createBooleanElement( taoQTI_models_classes_QTI_Data $qtiObject, $optionName, $elementLabel = '', $boolean = array('no', 'yes'))
    {
        $returnValue = null;
     ...
     * @return tao_helpers_form_FormElement
     */
    public static function createTextboxElement( taoQTI_models_classes_QTI_Data $qtiObject, $optionName, $elementLabel = '')
    {
        $returnValue = null;
...
} /* end of class taoQTI_actions_QTIform_AssessmentItem */
