 ...
 * @subpackage actions_QTIform_choice
 */
abstract class taoQTI_actions_QTIform_choice_Choice
    extends tao_helpers_form_FormContainer
{
     ...
     * @param  Data choice
     */
    public function __construct( taoQTI_models_classes_QTI_Data $choice = null)
    {
        // section 10-13-1-39-643eb156:12d51696e7c:-8000:0000000000004FF4 begin
		
		if(!is_null($choice)){
			$this->choice = $choice;
			if($choice instanceof taoQTI_models_classes_QTI_Group){
    ...
    public function setCommonElements()
    {
		...
		if($this->choice instanceof taoQTI_models_classes_QTI_Group){
...
} /* end of abstract class taoQTI_actions_QTIform_choice_Choice */
