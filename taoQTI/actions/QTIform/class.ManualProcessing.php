    ...
    extends taoQTI_actions_QTIform_ResponseProcessingOptions
{
     ...
     * @return mixed
     */
    public function __construct( taoQTI_models_classes_QTI_Interaction $interaction,  taoQTI_models_classes_QTI_response_ResponseProcessing $responseProcessing,  taoQTI_models_classes_QTI_Outcome $outcome)
    {
