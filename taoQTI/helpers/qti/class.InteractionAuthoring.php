...
class taoQTI_helpers_qti_InteractionAuthoring
{
     ...
     * @return array
     */
    public static function getIRPData( taoQTI_models_classes_QTI_Item $item,  taoQTI_models_classes_QTI_Interaction $interaction)
    {
        $returnValue = array();
     ...
     */
    private static function getManualRPData( taoQTI_models_classes_QTI_Item $item,  taoQTI_models_classes_QTI_Interaction $interaction)
    {
        $returnValue = null;
     ...
     * @return array
     */
    private static function getMapingRPData( taoQTI_models_classes_QTI_Item $item,  taoQTI_models_classes_QTI_Interaction $interaction)
    {
        $returnValue = array();
     ...
     * @return array
     */
    private static function getCorrectRPData( taoQTI_models_classes_QTI_Item $item,  taoQTI_models_classes_QTI_Interaction $interaction)
    {
        $returnValue = array();
