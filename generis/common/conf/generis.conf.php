...
# local namespace
define('LOCAL_NAMESPACE','http://localhost:8888/tao/tao.rdf');

# platform identification
define('GENERIS_INSTANCE_NAME','tao');
define('GENERIS_SESSION_NAME','tao_neh6lboy');

# paths
define('ROOT_PATH','/Applications/MAMP/htdocs/tao/');
define('ROOT_URL','http://localhost:8888/tao/');
...
define('SYS_USER_LOGIN','fcg6ho8b');
define('SYS_USER_PASS','b72790473db3fe47ef452cc5833db9c5');
